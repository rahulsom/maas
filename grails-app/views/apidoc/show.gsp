    ...
    <g:each in="${controller.value}" var="act">
      <g:each in="${act}" var="action">
        ...
        <g:each in="${action.value}" var="vers">
          ...
          <g:if test="${vers.value.method}"><g:set var="method"
                                                   value="${vers.value.method.replace('[', '').replace(']', '').split(',').findAll {
                                                     it =~ /(GET|PUT|POST|DELETE|PATCH|TRACE)/
                                                   }[0]?.toLowerCase()}"/></g:if>
          ...
          <div class="methodList" style="display:none;">
            ...
            <div class="method ${method}Dark"><a href="#" onClick="toggleInfoBox(this);">${method?.toUpperCase()}</a>
            </div>

            <div class="path ${method}Light">${path}<img src="/images/pix.gif" class="methodSeparator"/>

              <div class="${method}Desc"">${description}</div></div>
          ...
          <g:if test="${links?.size() > 0}">
            <div class="table ${method}TableContrast">
              <div class="${method}HeadContrast">
                <span style="display: table-cell;width: 740px;padding-left: 10px;border: 1px #d7ad7b;"><b>Links</b>
                </span>
              </div>
          ...
          <div class="table ${method}TableContrast">
            <div class="${method}HeadContrast">
              ...
              <span style="display: table-cell;width: 200px;padding-left: 10px;border: 1px #d7ad7b;"><b>Description</b>
              </span>
              <span style="display: table-cell;width: 200px;padding-left: 10px;border: 1px #d7ad7b;"><b>Params</b>
              </span>
            </div>
            <g:each in="${receives}" var="value">
              <div class="${method}RowContrast">
                <span
                    style="display: table-cell;width: 150px;padding-left: 10px;border: 1px #d7ad7b;">${(['PKEY', 'FKEY', 'INDEX'].contains(value.paramType.toString())) ? 'ID' : value.paramType}</span>
                <span
                    style="display: table-cell;width: 150px;padding-left: 10px;border: 1px #d7ad7b;">${value.name}</span>
                <span
                    style="display: table-cell;width: 200px;padding-left: 10px;border: 1px #d7ad7b;">${value.description}</span>
          ...
          <g:if test="${returns?.size() > 0}">
            ...
            <div class="table ${method}TableContrast">
              <div class="${method}HeadContrast">
                <span style="display: table-cell;width: 150px;padding-left: 10px;border: 1px #d7ad7b;"><b>Type</b>
                </span>
                <span style="display: table-cell;width: 150px;padding-left: 10px;border: 1px #d7ad7b;"><b>Name</b>
                </span>
                <span
                    style="display: table-cell;width: 200px;padding-left: 10px;border: 1px #d7ad7b;"><b>Description</b>
                </span>
                <span style="display: table-cell;width: 200px;padding-left: 10px;border: 1px #d7ad7b;"><b>Params</b>
                </span>
              </div>
              ...
              <g:each status="i" in="${returns}" var="rturn">
                <div class="${method}RowContrast">
                  <span
                      style="display: table-cell;width: 150px;padding-left: 10px;border: 1px #d7ad7b;">${(['PKEY', 'FKEY', 'INDEX'].contains(rturn.paramType.toString())) ? 'ID' : rturn.paramType}</span>
                  <span
                      style="display: table-cell;width: 150px;padding-left: 10px;border: 1px #d7ad7b;">${rturn.name}</span>
                  <span
                      style="display: table-cell;width: 200px;padding-left: 10px;border: 1px #d7ad7b;">${rturn.description}</span>
                  <span style="display: table-cell;width:200px;padding-left: 10px;border: 1px #d7ad7b;">[]</span>
                </div>
              </g:each>
            </div>
          ...
          <g:if test="${errors?.size() > 0}">
            ...
            <div class="table ${method}TableContrast">
              <div class="${method}HeadContrast">
                <span style="display: table-cell;width: 100px;padding-left: 10px;border: 1px #d7ad7b;"><b>Code</b>
                </span>
                <span
                    style="display: table-cell;width: 630px;padding-left: 10px;border: 1px #d7ad7b;"><b>Description</b>
                </span>
              </div>
              <g:each in="${errors}" var="error">
                <div class="${method}RowContrast">
                  <span
                      style="display: table-cell;width: 100px;padding-left: 10px;border: 1px #d7ad7b;">${error.code}</span>
                  <span
                      style="display: table-cell;width: 630px;padding-left: 10px;border: 1px #d7ad7b;">${error.description}</span>
                </div>
              </g:each>
            </div>
            </br>
